    ...
    <section className="w-[90%] mx-auto">
        <div className="flex flex-wrap justify-between items-center gap-8 p-6">
            ...
            <div className="flex justify-start">
                <img src="/static/media/harvest.png" className="w-8 h-8 mx-1" alt="harvested quantities" />
                <div className="">
            ...
            <div className="flex justify-start">
                <img src="/static/media/grown.png" className="w-8 h-8 mx-1" alt="grown food" />
                <div className="">
            ...
            <div className="flex justify-start">
                <img src="/static/media/produced.png" className="w-8 h-8 mx-1" alt="food produced" />
                <div className="">
