    ...
    <div className="missionBg py-[104px]">
        ...
        <div className="missionRight">
            ...
            <div className="missionRightTop">
                <img src="/static/media/hero1.png"/>
                <img  className="missionImg2" src="/static/media/hero2.png"/>
            ...
            {/* Bottom */}
                <img src="/static/media/hero3.png"/>
                <img  className="missionImg2" src="/static/media/hero4.png"/>
            </div>
        </div>
    </div>
  )
