        ...
        <div className="Transporters flex justify-center ">
            ...
            <div className="InnerBackground absolute top-[20px] bg-white  border-[1px] border-gray-500 shadow-gray-500 shadow-md lg:w-[90%] bg-center rounded-[30px] mx-[8px]  lg:mx-auto">
                ...
                <div className="MainTitle">
                    <p className="text-center text-[16px] lg:text-[40px] font-inter font-[700] text-[#008000]">Welcome To Freshly Verified Fermers Center!</p>
                </div>
                <div className="SetOfCards mx-[10px] lg:mx-[240px]  mb-[20px] lg:mb-[100px] "  >
                    ...
                    <div className="PhysicalAddress mt-[28px]">
                            <p className="text-start font-inter font-[700] text-[16px] lg:text-[23px] my-0 text-[#008000] ">What do you grow /want to grow using this product ?</p>
                    ...
                    <Link to="/verified-success" className="">
                        <button className="SubmitButton cursor-pointer font-inter font-[700] lg:mt-10 text-white text-[16px] lg:text-[30px] bg-[#008000] w-full py-[20px] rounded-[12px] px-[20px] my-0 border-none active:scale-90 transition-all duration-100 ease-out">SUBMIT</button>
                    </Link>
