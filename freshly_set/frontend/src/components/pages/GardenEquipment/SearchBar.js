...
function SearchBar() {
  ...
  return (
    <div>
      <form onSubmit={handleSearch} className="absolute translate-x-[25%]  z-20  w-[853.653px] hidden lg:flex items-center justify-center border-[#008000] bg-white-100 pb--2">
            <div className="flex justify-between items-center   w-[853.653px] font-[600]  rounded-[20px] my-[] border-solid border-[5px] bg-white border-[#008000] mb-[-150px] mt-[12px] shadow-lg">
