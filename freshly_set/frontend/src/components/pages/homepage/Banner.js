...
function Banner() {
  return (
    <section id="promotion" className="hidden lg:flex relative h-[198.251px] lg:h-[570px] w-auto bg-gradient-to-t from-[#FF0C1A]   via-[#1A1A1A] via-[20%] to-[#1A1A1A]  pl-[14px] rounded-[29px] mx-[10px] lg:mx-[24px] lg:mt-[67px]">
