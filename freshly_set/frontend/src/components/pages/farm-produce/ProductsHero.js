    ...
    <div className="block overflow-x-hidden">
        <div className="mt-[150px] relative h-[415px] lg:h-[667px] w-[100%] bg-hero-products bg-fixed  bg-cover bg-no-repeat mix-blend-luminosity ">
            ...
            <div className="absolute block  z-[25] top-[20px] lg:top-[192px]  lg:left-[69px] lg:w:[592px] rounded-[16px] bg-[#A6B1AD99]/[60%] lg:px-[28px]">
                <h3 className="text-black text-[25px] lg:text-[35px] font-inter font-[900] lg:w-[592px] leading-[30px] lg:leading-[57.6px] text-center">SHOP GARDEN SETUPS AND FARMING SYSTEMS</h3>
