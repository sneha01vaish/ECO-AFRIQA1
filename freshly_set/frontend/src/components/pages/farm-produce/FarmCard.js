...
function FarmCard({  img, title, body, rating}) {
  ...
  return (
    <div className="flex relative  w-[673px] bg-[#00AA5B1A]/[0.10] rounded-[24px] py-[32px] px-[31px]">
        ...
        <div className="ml-[31px] block lg:-mt-[20px]">
            ...
            <p className={clicked[1] === !true ? "flex mt-[14px] text-[10px] lg:text-[16px] font-[600] text-start w-[131.875px] lg:w-[258px] lg:leading-[20.8px] leading-[13px] font-josefin":"hidden"}>{body}</p>
        ...
        <FaCaretDown 
                        ...
                        className={`text-black h-[30px] lg:h-[52px] w-[20.8px] lg:w-[55px]  mr-[14px] lg:mr-[17px]  cursor-pointer transition-all duration-300 ease-in-out ${clicked[3] ? "rotate-180" : ""}`}
                    />
