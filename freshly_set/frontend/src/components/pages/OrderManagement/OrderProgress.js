...
function OrderProgress() {
    ...
    return (
        <div className="OrderProgress mb-[200px] mt-[150px] lg:mt-[200px]">
            {/*Navbar */}
            ...
            {/*Back Button */}
            <div className="mx-[12px] lg:mx-[40px] w-fit" >
            ...
            {/*Order Status */}
            <div className="OrderStatusBanner bg-gradient-to-r from-[#007000] to-[#000A00] shadow-md shadow-[#00000040] mx-[4px] lg:mx-[14px] mt-[20px] lg:pb-[20px] rounded-[15px] lg:rounded-[29px]">
                <div className="OrderStatusBannerWrapper px-[10px] lg:px-[30px] py-[30px]">
                    
                    {/*Progress Title */}
                    <div className="TitleWrapper block">
                        <h3 className="text-start font-[700] font-inter text-[20px] lg:text-[35px] text-[#FFFFFF] my-0">Your Order Progress</h3>
                    </div>
                        
                    {/*ProgressBars */}
                    <div className="ProgressBars block mt-[16px] lg:mt-[28px]">
                        <div className="ProgressBarsWrapper grid grid-cols-4 lg:flex lg:justify-between">
                            {/*OrderConfirmation */}
                            <div className="block">
                                <div className="OrderConfirmation bg-[#D9D9D9] h-[9px] lg:h-[10px] w-[60px] lg:w-[247px] ">
                                ...
                                <div className="OrderTag">
                                    <p className="text-start text-[9px] lg:text-[20px] font-inter font-[700] bg-gradient-to-b bg-clip-text text-transparent from-[#ffffff] to-[#999999]">Order Confirmation</p>
                                </div>
                            </div>

                            {/*OrderPayment */}
                            <div className="block">
                                <div className="OrderPayment bg-[#D9D9D9] h-[9px] lg:h-[10px] w-[60px] lg:w-[247px] ">
                                ...
                                <div className="OrderTag">
                                    <p className="text-start text-[9px] lg:text-[20px] font-[700] font-inter bg-gradient-to-b bg-clip-text text-transparent from-[#ffffff] to-[#999999]">Payment</p>
                                </div>
                            </div>

                            {/*OrderProcessing */}
                            <div className="block">
                                <div className="OrderProcessing bg-[#D9D9D9] h-[9px] lg:h-[10px] w-[60px] lg:w-[247px] ">
                                ...
                                <div className="OrderTag">
                                    <p className="text-start text-[9px] lg:text-[20px] font-[700] font-inter bg-gradient-to-b bg-clip-text text-transparent from-[#ffffff] to-[#999999]">Processing</p>
                                </div>
                            </div>
                            
                            {/*OrderDelivery */}
                                <div className="block">
                                <div className="OrderDelivery bg-[#D9D9D9] h-[9px] lg:h-[10px] w-[60px] lg:w-[247px] ">
                                ...
                                <div className="OrderTag">
                                    <p className="text-start text-[9px] lg:text-[20px] font-inter font-[700] bg-gradient-to-b bg-clip-text text-transparent from-[#ffffff] to-[#999999]">Delivery</p>
                                </div>
                            </div>
                    ...
                    <div className="DeliveryDateAndTime mt-[40px] py-[4px] lg:py-[16px] px-[6px] lg:px-[14px] bg-[#FFFFFF] rounded-[6px] lg:rounded-[16px] lg:w-fit border-solid border-[1px] lg:border-[3px] border-[#008000] ">
                        <p className="text-start font-[700] font-inter text-[9px] lg:text-[20px] text-[#000000] my-0"> Estimated Delivery Date And Time: {Date}, {Time} </p>
                    </div>                  
            ...
            <div className="OrderProgressWrapper mt-[30px] mx-[12px] lg:mx-[200px] px-[14px] lg:px-[28px] py-[10px] lg:py-[24px] rounded-[8px] lg:rounded-[18px] border-solid border-[0.6px] border-[#A6B1AD] shadow-md shadow-[#00000040]">
                ...
                <div className="OrderProgressTitle mt-[10px]">
                    <p className="text-start font-inter font-[700] text-[15px] lg:text-[28px] text-[#008000] my-0 ">Your Items</p>
                </div>
                
                {/*Titles of Sections */}
                <div className="OrderItemWrapper grid grid-cols-2 gap-[30px] mt-[20px]">
                {/*Item Picture, Category and Name */}
                <div className="ItemPictureAndName block">
                    <p className="text-start font-inter font-[700] text-[12px] lg:text-[16px] text-[#00000] my-0 ">Item</p>
                ...
                <div className="ItemQttyAndStatus block ">
                    <div className="ItemQttyAndStatusWrapper grid grid-cols-2">
                        ...
                        <div className="ItemQtty">
                            <p className="text-center font-inter font-[700] text-[12px] lg:text-[16px] text-[#000000] my-0">Quantity</p>
                        </div>
                        {/*Items Order Status*/}
                        <div className="ItemStatus">
                            <p className="text-center font-inter font-[700] text-[12px] lg:text-[16px] text-[#000000] my-0"> Status</p>
                        </div>
